...
public class Topic_2_Variable_Property_Method {
	...
	public static void main(String[] args) {
		Topic_2_Variable_Property_Method firstStudent = new Topic_2_Variable_Property_Method();
		...
		Topic_2_Variable_Property_Method secondStudent = new Topic_2_Variable_Property_Method();
