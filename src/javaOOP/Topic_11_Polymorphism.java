...
public class Topic_11_Polymorphism {
	...
	public static void main(String[] args) {
		Topic_11_Polymorphism firstStudent = new Topic_11_Polymorphism();
		...
		Topic_11_Polymorphism secondStudent = new Topic_11_Polymorphism();
