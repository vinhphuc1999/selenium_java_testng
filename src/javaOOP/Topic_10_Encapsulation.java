...
public class Topic_10_Encapsulation {
	...
	public static void main(String[] args) {
		Topic_10_Encapsulation firstStudent = new Topic_10_Encapsulation();
		...
		Topic_10_Encapsulation secondStudent = new Topic_10_Encapsulation();
