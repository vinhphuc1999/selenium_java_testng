...
public class Topic_12_Abstraction {
	...
	public static void main(String[] args) {
		Topic_12_Abstraction firstStudent = new Topic_12_Abstraction();
		...
		Topic_12_Abstraction secondStudent = new Topic_12_Abstraction();
