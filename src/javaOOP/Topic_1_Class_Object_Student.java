...
public class Topic_1_Class_Object_Student {
	...
	public static void main(String[] args) {
		Topic_1_Class_Object_Student firstStudent = new Topic_1_Class_Object_Student();
		...
		Topic_1_Class_Object_Student secondStudent = new Topic_1_Class_Object_Student();
